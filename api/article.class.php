...
require_once ("../app/core/api-class/model.php");
...
class articleController extends model {
    ...
    public function getArticles() {
        ...
        $query = "SELECT a.id_art,a.code_art,a.nom_art,a.ref_art,a.seuil_art,a.marq_art,a.model_art,a.caract_art,a.unite_art,a.cat_art,c.nom_cat,u.nom_unite,p.prix_mini_art,p.prix_max_art,p.prix_gros_art,p.prix_achat_art  FROM t_article a 
                      left join (select * from t_prix_article  WHERE a_jour=0) p on a.id_art=p.art_prix_art 
    ...
    public function queryArticles() {
        ...
        $query = "SELECT a.id_art,a.code_art,a.nom_art,a.ref_art,a.seuil_art,a.marq_art,a.model_art,a.caract_art,a.unite_art,a.cat_art,c.nom_cat,u.nom_unite,p.prix_mini_art,p.prix_max_art,p.prix_gros_art,p.prix_achat_art  FROM t_article a 
                      left join (select * from t_prix_article  WHERE a_jour=0 GROUP BY art_prix_art DESC) p on a.id_art=p.art_prix_art 
                      inner join t_categorie_article c on a.cat_art=c.id_cat
                      inner join t_unite_article u on a.unite_art=u.id_unite
                      WHERE a.nom_art like '%$qry%' OR a.ref_art like '%$qry%' OR c.nom_cat like '%$qry%'
                      ORDER BY CASE WHEN c.activite=" . $_SESSION['userMagAct'] . " THEN 0 ELSE 1 END ASC,a.nom_art";
        $r = $this->mysqli->query($query) or die($this->mysqli->error . __LINE__);
    ...
    public function loadMore() {
        ...
        $query = "SELECT a.id_art,a.code_art,a.nom_art,a.ref_art,a.seuil_art,a.marq_art,a.model_art,a.caract_art,a.unite_art,a.cat_art,c.nom_cat,u.nom_unite,p.prix_mini_art,p.prix_max_art,p.prix_gros_art,p.prix_achat_art  FROM t_article a 
                      ...
                      inner join t_categorie_article c on a.cat_art=c.id_cat
                      inner join t_unite_article u on a.unite_art=u.id_unite
                      ORDER BY CASE WHEN c.activite=" . $_SESSION['userMagAct'] . " THEN 0 ELSE 1 END ASC,a.nom_art limit 50 offset $offset";
        $r = $this->mysqli->query($query) or die($this->mysqli->error . __LINE__);
    ...
    public function getLmArticles() {
        ...
        $query = "SELECT a.id_art,a.code_art,a.nom_art,a.ref_art,a.seuil_art,a.marq_art,a.model_art,a.caract_art,a.unite_art,a.cat_art,c.nom_cat,u.nom_unite,p.prix_mini_art,p.prix_max_art,p.prix_gros_art,p.prix_achat_art  FROM t_article a 
                      left join (select * from t_prix_article  WHERE a_jour=0 GROUP BY art_prix_art DESC ORDER BY date_prix desc) p on a.id_art=p.art_prix_art 
                      inner join t_categorie_article c on a.cat_art=c.id_cat
                      inner join t_unite_article u on a.unite_art=u.id_unite
                      ORDER BY CASE WHEN c.activite=" . $_SESSION['userMagAct'] . " THEN 0 ELSE 1 END ASC,a.nom_art limit 50";
    ...
    public function getArticlePrices($id_art) {
        ...
        $query = "SELECT ta.prix_mini_art as prix_mini_art,ta.prix_max_art as prix_max_art,ta.prix_gros_art as prix_gros_art,ta.prix_achat_art  FROM 
