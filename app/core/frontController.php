    ...
    public function login() {
        ...
        if (!empty($this->_request['login']) and !empty($this->_request['password'])) {
            ...
            if ($r->num_rows > 0) {
                ...
                $_SESSION['droitAnnuleDepense'] = $result['droit_annule_depense'];
