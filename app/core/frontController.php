    ...
    public function login() {
        ...
        if (!empty($this->_request['login']) and !empty($this->_request['password'])) {
            ...
            if ($r->num_rows > 0) {
                ...
                $_SESSION['droitValidateurDepense'] = $result['droit_validateur_depense'];
