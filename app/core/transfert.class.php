...
class transfertController extends model {
  ...
  public function etatTransf() {
        ...
        if ($_SESSION['userMag'] != 0)
            $query = "SELECT t.id_transf, time(t.date_transf) as heure_transf,t.user_transf,u.code_user,t.qte_transf,DATE(t.date_transf) as date_transf,m.nom_mag as nom_mag_src,
                ...
                FROM t_transfert t
                 ...
                 INNER JOIN t_user u ON t.user_transf=u.id_user WHERE t.mag_src_transf=" . intval($_SESSION['userMag']);
        else
            $query = "SELECT t.*,u.code_user,time(t.date_transf) as heure_transf,m.nom_mag as nom_mag_src,
