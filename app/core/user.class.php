...
class userController extends model {
    ...
    public function updateUser() {
        ...
        $column_names = array('sexe_user','nom_user', 'login_user', 'prenom_user', 'code_user', 'mail_user','regl_credit','vente_credit','facture_vente_annulee','droit_facture_vente_annulee_today','droit_controle_prix_vente','droit_reglement_facture_credit','droit_confirmation_approvisionnement','droit_confirmation_production','droit_paiement','droit_depense','droit_annule_depense','droit_approvisionnement');
