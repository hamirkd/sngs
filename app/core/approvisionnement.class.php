...
class approvisionnementController extends model {
    ...
    public function getApprovisionnements() {
        ...
        if ($_SESSION['userMag'] > 0)
            ...
            WHERE app.actif=1 
             AND  ta.mag_appro_art = " . $_SESSION['userMag'] . "
    ...
    public function insertStockApproConfirmation() {
        ...
        if (!empty($appstock)) {
            try {
                ...
                $query = "UPDATE  t_approvisionnement_article SET code_user_confirm='" . $_SESSION['userCode'] . "', date_confirm=now() WHERE id_appro_art=".$appstock['id_appro_art'];
