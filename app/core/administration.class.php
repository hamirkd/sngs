...
class administrationController extends model {
    ...
    public function __construct() {
     ...
     public function save() {
        ...
        switch ($variable) {
            case 'NOUVEAU':
                shell_exec("C:/wamp64/bin/mysql/mysql5.7.31/bin/mysqldump -u root --password=adminroot -f --databases bd_songo_lina > $file");
                break;
            case 'ANCIEN':
                shell_exec("C:/wamp/bin/mysql/mysql5.6.17/bin/mysqldump -u root --password=adminroot -f --databases bd_songo_lina > $file");
                break;
            case 'DEVELOPPEMENT':
                shell_exec("C:/xampp/mysql/bin/mysqldump -u root --password=adminroot -f --databases bd_songo_lina > $file");
                break;
            default:
                break;
        }
