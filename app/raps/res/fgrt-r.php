...
$query1 = "SELECT  
            ...
            WHERE fv.clnt_fact=$client and 
                fv.bl_fact_grt=1 AND 
                fv.sup_fact=0 AND 
                fv.bl_crdt_regle=0 AND 
                fv.crdt_fact>0 AND (fv.crdt_fact-fv.som_verse_crdt)>0 ORDER BY fv.date_fact DESC";
...
<table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 10pt;">
        <tr>
            ...
            <th style="width: 22%; text-align: right;background-color:#bbb;"><?php echo number_format($totalGenerale, 0, ',', ' '); ?> FCFA</th>
        </tr>
</table>
