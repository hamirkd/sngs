...
<!--<page format="140x200" orientation="L" backcolor="#fff" style="font: arial;">-->
<page backtop="5mm" format="140x200" orientation="L" backbottom="10mm" backleft="10mm" backright="10mm" backcolor="#fff" style="font: arial;">
    <page_footer>
    ...
    $query = "SELECT f.id_fact,f.bl_fact_crdt,f.bl_tva,
        ...
        COALESCE(c.bp_clt,'- - - - - - -') as bp_clt,
          m.nom_mag,f.code_caissier_fact,DATE(f.date_fact) as date_fact,
        m.nom_mag
                           FROM 
                           t_facture_vente f
...
<?php //if ($bltva==1 ):  ?>
    <table style="width:98%;" align='center' border="0">
        <tr>
            <td   style="width:38%;text-align:left;border:1px solid black;font-size:8px;font-weight:bold;"> 
                <table>
                    <tr>
                        <td><u>DOIT</u></td>
...
<td   style="width:58%;text-align:left;border:1px solid black;font-size:8px;font-weight:bold;">
    <table>
        <tr>
...
<table cellspacing="0" style="width: 100%;background: #fff; text-align: center; font-size: 8pt;" align="center">
    <tr>
        ...
        <td class="signataire" style="width: 50%; text-align: center;">
            ...
            <?php
            if ($_SESSION['userMag'] == 3)
                echo " M. _ _ _ _ _ _ _ _ _ _";
            else if ($_SESSION['userMag'] == 1 || $_SESSION['userMag'] == 2)
                echo " M. _ _ _ _ _ _ _ _ _ _";
            else if ($_SESSION['userMag'] == 4)
                echo " M. _ _ _ _ _ _ _ _ _ _";
            else
                echo " El HADJ";
            ?>
    ...
    <?php if ($blcrdt == 1): ?> 
    <page backtop="5mm"format="140x200" orientation="L"  backbottom="10mm" backleft="10mm" backright="10mm" backcolor="#fff" style="font: arial;"> <page_footer>
        <?php include "includes/footer.php"; ?>
        </page_footer>  
        <?php
        $condMag = "";
        ...
        $query = "SELECT f.id_fact,f.bl_tva,f.bl_bic,f.remise_vnt_fact,f.code_fact,COALESCE(c.nom_clt,'Client : _ _ _ _ _ _') as nom_clt,m.nom_mag,f.code_caissier_fact,DATE(f.date_fact) as date_fact,m.nom_mag
                           FROM 
                           t_facture_vente f
                           LEFT JOIN t_client c ON f.clnt_fact=c.id_clt 
                           INNER JOIN t_magasin m ON f.mag_fact=m.id_mag 
    ...
    ?>
        <table style="width:100%;">
            <tr>
                <td style="width: 100%">
                    ...
                    <table style="width:98%;" align='center'>
                        <tr>
                            <td style="text-align:center;"><u><h5>&nbsp;BORDEREAU DE LIVRAISON No <?php echo $num; ?>/<?php $dt = explode('-', $date);
                            echo $dt[0];
                            ?>/<?php echo NOM_STRUCT_ABBR; ?></h5></u>  </td>
            </tr>
        </table>
        <table style="width:98%" align="center" cellspacing="0">
            <tr style="color:black;">
                <th style="width: 3%;text-align: left;border:1px solid black;">No</th>
                <th style="width: 13%;text-align: left;border:1px solid black;">Qte</th>
                <th style="width: 63%;text-align: left;border:1px solid black;">Designation</th>
                <th style="width: 21%;text-align: left;border:1px solid black;">Observ..</th>
            </tr> 
    ...
    while ($row = $r->fetch_assoc()) {
        ...
        ?>
                <tr >
                    <td class="chiffre" style="width: 3%; text-align: left;border-left:1px solid black;">-<?php echo $total; ?>-</td>
                    <td class="chiffre" style="width: 13%;text-align: right;border-left:1px solid black;"><?php echo $row['qte_vnt']; ?></td>
                    <td style="width: 63%; text-align: left;border-left:1px solid black;font-weight:bold;"><?php echo strtoupper($row['nom_art']); ?></td>
                    <td style="width: 21%; text-align: right;border-left:1px solid black;border-right:1px solid black;"></td>
                </tr>
    ...
    ?>  
        ...
        <table style="width:98%" align="center" cellspacing="0">
            <tr style="color:black;">
                <th style="width: 3%;text-align: left;border-top:1px solid black;"></th>
                <th style="width: 13%;text-align: left;border-top:1px solid black;"></th>
                <th style="width: 63%;text-align: left;border-top:1px solid black;"></th>
                <th style="width: 21%;text-align: left;border-top:1px solid black;"></th>
            </tr> 
        </table>
        ...
        <table cellspacing="0" style="width: 100%;background: #fff; text-align: center; font-size: 8pt;" align="center">
            <tr>
                ...
                <td class="signataire" style="width: 50%; text-align: center;">
                    ...
                    <strong> LE RECEPTIONNISTE</strong> 
                </td>
            </tr>
        </table>
        ...
        <table style="width:100%;">
            <tr>
                <td style="width: 100%">
                    ...
                    <table style="width:98%;" align='center'>
                        <tr>
                            <td coslpan='3'><u><h5>&nbsp;FACTURE PROFORMA No <?php echo $num; ?>/<?php $dt = explode('-', $date);
    echo $dt[0];
    ?>/<?php echo NOM_STRUCT_ABBR; ?></h5></u>  </td>
            </tr>
        </table>
    ...
    <table align="center" cellspacing="0" style="width: 98%; border: solid 1px black; background: #fff; text-align: center; font-size: 10pt;">
          <tr>
            <th style="width: 83%; text-align: right;border-right:1px solid black;">
  TOTAL : </th>
            <th class="chiffre" style="width: 17%; text-align: right;font-style:italic;"><?php echo number_format($som /* - $remise */, 2, ',', ' '); ?></th>
        </tr>
    </table>
