...
<page backtop="30mm" backbottom="10mm" backleft="10mm" backright="10mm" orientation="paysage">
    ...
    $condmag = "";
        ...
        $query = "SELECT date(c.date_crce_clnt) as date_crce_clnt,
            ...
            WHERE fv.bl_fact_grt=1 $condmag";
    ...
    if ($r->num_rows > 0) {
        ...
        <table class="data" cellspacing="0" cellpadding="5mm" style="width: 100%; border: solid 1px black;text-align: center; font-size: 10pt;">
            <tr style="">
                ...
                <th style="width: 25%;text-align: left;border:1px solid black;">No FACTURE</th>
                <th style="width: 33%;text-align: left;border:1px solid black;">CLIENT</th>
            ...
            while ($row = $r->fetch_assoc()) {
                ...
                <tr >
                    ...
                    <td style="width: 25%; text-align: left"><?php echo ucfirst(strtolower($row['code_fact'])); ?></td>
                    <td style="width: 33%;text-align: left"><?php echo ucwords(strtolower($row['nom_clt'])); ?></td>
        ...
        <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 10pt;">
            <tr>
                <th style="width: 100%; text-align: left;">Aucune avance de client.. </th> 
            </tr>
        </table>
        <?php
    }
