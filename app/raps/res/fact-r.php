...
<page backtop="45mm" backbottom="10mm" backleft="10mm" backright="10mm" backcolor="#fff" style="font: arial;">
    ...
    $query = "SELECT f.id_fact,f.bl_fact_crdt,f.bl_fact_grt,f.bl_tva,f.sup_fact,f.som_verse_crdt,f.crdt_fact,
    ...
    <div style="position:absolute;top:150px;right:250px;-moz-transform:rotate(-30deg);z-index:99999;">
        <?php if ($sup_fact == 1) : ?>
            <img width="200" height="100"  src="../../public/images/ann.png" alt="annulee"   />
        <?php endif; ?>  
    </div>
<!--    <table style="width:100%;">
        <tr>
            <td style="width: 100%">-->
                ...
                <table style="width:98%;border-collapse: collapse;" border="0" align='right'>
                    <tr>
                        <td style="width: 45%;text-align: center;padding:5px;vertical-align: middle;">
                            <table   align="center" style="vertical-align: middle;border: 1px solid black;border-collapse: collapse;">
                                <tr style="border: 1px solid black;border-collapse: collapse;">
                                    <th style="border: 1px solid black;border-collapse: collapse;">Num&eacute;ro</th>
                        ...
                        <td  style="width: 55%;text-align: left;padding:5px;vertical-align: top;">
                            <div style="text-align: center; border: 1px solid black;border-collapse: collapse;padding:5px;font-weight: bold;"> <u>DOIT (ADRESSE DE FACTURATION) :</u><br/>
                ...
                <table style="width:98%;border: 1px solid black;border-collapse: collapse;" align="center" border="01">
                    <tr>
                    ...
                    while ($row = $r->fetch_assoc()) {
                        ...
                        ?>
                        <tr >
                            <td  style="width: 53%; text-align: left;font-weight:normal;"><?php echo strtoupper($row['nom_art']); ?></td>
                            <td style="width: 13%;"><?php echo $row['qte_vnt']; ?></td>
                            <td style="width: 17%;"><?php echo number_format($row['pu_theo_vnt'], 0, ',', ' '); ?></td>
                            <td style="width: 17%;"><?php echo number_format($row['qte_vnt'] * $row['pu_theo_vnt'], 0, ',', ' '); ?></td>
                        </tr>
                ...
                <table  style="width: 98%;background: #fff; text-align: center; font-size: 8pt;border: 1px solid black;border-collapse: collapse;" align="center">
                    <tr>
                ...
                <?php if ($bltva == 0 && $blbic == 0): ?> 
                    <table style="width:98%;border: 1px solid black;border-collapse: collapse;" align="center" border="01" class="line-montant" cellpadding="01"> 
                        <tr>
                ...
                <!-- 
                    ...
                    ===========================================
                -->
                <?php if ($resultFacture['bl_fact_crdt'] == 1): ?> 
                    <br>
                    <table style="width:98%;border: 1px solid black;border-collapse: collapse;" align="center" border="01" class="line-montant" cellpadding="01"> 
                        <tr>
                            <th style="width: 25%; text-align: center;border-left:transparent;border-top:transparent;border-bottom:transparent;"></th>
                            <th style="width: 35%; text-align: center;">AVANCE</th>
                            <th style="width: 40%;text-align: center;">RESTE A PAYÉ</th>
                        </tr>
                        <tr>
                            <td style="border-left:transparent;border-top:transparent;border-bottom:transparent;"></td>
                            <td style="width: 35%; text-align: center;border: 1px solid black;">
                                <?php
                                echo number_format($resultFacture['som_verse_crdt'], 0, ',', ' ');
                                ?>
                            </td>
                            <td style="width: 40%;text-align: center;">
                                <?php echo number_format($resultFacture['crdt_fact']-$resultFacture['som_verse_crdt'], 0, ',', ' '); ?>
                            </td>
                        </tr>
                    </table>
                    <br>
...
<page backtop="45mm" backbottom="10mm" backleft="10mm" backright="10mm" backcolor="#fff" style="font: arial;">
    ...
    $query = "SELECT f.id_fact,f.bl_tva,f.bl_bic,f.bl_fact_crdt,f.remise_vnt_fact,f.code_fact,f.sup_fact,
