    ...
    if ($r->num_rows > 0) {
        ...
        <table class="data" cellspacing="0" cellpadding="5mm" style="width: 100%; border: solid 1px black;text-align: center; font-size: 10pt;">
            <tr style="">
                ...
                <th style="width: 9%;border:1px solid black;text-align: left">P.Gros</th>
            ...
            while ($row = $r->fetch_assoc()) {
                ...
                <tr >
                    ...
                    <td style="width: 25%;border:1px solid black;text-align: left"><?php echo ucwords(strtolower($row['nom_cat'])); ?></td>
