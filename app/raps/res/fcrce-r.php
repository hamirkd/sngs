...
$query1 = "SELECT  
            ...
            WHERE fv.clnt_fact=$client AND fv.sup_fact=0 and fv.crdt_fact>0 AND (fv.crdt_fact-fv.som_verse_crdt)>0 and fv.bl_fact_grt=0 AND fv.bl_crdt_regle=0 ORDER BY fv.date_fact DESC";
