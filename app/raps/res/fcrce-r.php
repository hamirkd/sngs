...
<?php
$condMag = "";
if(isset($magasin)&&intval($magasin)>0){
    $condMag = " AND fv.mag_fact=" . intval($magasin);
}
// echo $_SESSION['userMag'];
...
$query1 = "SELECT  
            ...
            WHERE fv.clnt_fact=$client AND fv.sup_fact=0 $condMag and fv.crdt_fact>0 AND (fv.crdt_fact-fv.som_verse_crdt)>0 and fv.bl_fact_grt=0 AND fv.bl_crdt_regle=0 ORDER BY fv.date_fact DESC";
...
<table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 10pt;">
        <tr>
            <th style="width: 78%; text-align: Left;background-color:#E7E7E7;">TOTAL CREDITS : </th>
