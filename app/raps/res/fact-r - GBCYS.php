            ...
            <td style="width: 100%">
                    ...
                    <tr>
                                ...
                                <tr>
                                    <td>
                                        <strong> <?php
                                            ...
                                            $dt = explode('-', $date);
                                            echo $dt[0];
                                            ?>/<?php echo NOM_STRUCT_ABBR; ?></strong>
                                    </td>
                                    <td>
                                        <strong><?php
                                            $dt = explode('-', $date);
                        ...
                        <td  style="width: 55%;text-align: left;padding:5px;vertical-align: top;">
                            <div style="text-align: center;border:4px double #111;padding:5px;font-weight: bold;"> <u>DOIT (ADRESSE DE FACTURATION) :</u><br/>
                                ...
                                <?php if ($situation != "" && $situation != "-") echo strtoupper($situation) . "<br>"; ?><br>  
                ...
                <?php if ($bltva == 1 && $blbic == 0): ?> 
                    <table style="width:98%;border-collapse: initial;" align="center" border="01" class="line-montant" cellpadding="01"> 
                        <tr>
                            <th style="width: 25%; text-align: center;">TOTAL HT</th>
                            <th style="width: 25%;text-align: center;">TVA (<?php echo $_SESSION['tva']*100; ?>%)</th>
                ...
                <table cellspacing="0" style="width: 98%;background: #fff; text-align: center; font-size: 8pt;" align="center">
                    <tr>
                        <td style="width: 100%; text-align: left;">Arr&ecirc;t&eacute;e la pr&eacute;sente <span class="bold" >FACTURE</span> &Agrave; la somme de : &nbsp;<span class="bold"><?php echo strtoupper(ConvLetter($mntt, 0, 'fr')) . " (" . number_format($mntt, 2, ',', ' ') . ")"; ?>  FRANCS/CFA TTC</span></td>
                    </tr>
                </table>
                <br/>
                <br/> 
    ...
    <table style="width:100%;">
        <tr>
            <td style="width: 100%">
                ...
                <table cellspacing="0" style="width: 98%;background: #fff; text-align: center; font-size: 8pt;" align="center">
                    <tr>
                        <td style="width: 100%; text-align: left;">Arr&ecirc;t&eacute;e la pr&eacute;sente <span class="bold" >PRO FORMA</span> &Agrave; la somme de : &nbsp;<span class="bold"><?php echo strtoupper(ConvLetter($mntt, 0, 'fr')) . " (" . number_format($mntt, 2, ',', ' ') . ")"; ?>  FRANCS/CFA TTC</span></td>
                    </tr>
                </table>
                <br/>
                <br/> 
