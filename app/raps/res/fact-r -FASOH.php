...
<page backtop="5mm" format="140x200" orientation="L" backbottom="10mm" backleft="10mm" backright="10mm" backcolor="#fff" style="font: arial;">
    ...
    $query2 = "SELECT   m.resp_mag FROM  t_magasin m 
        ...
        <tr>
            <td style="width: 100%">
                ...
                <table style="width:98%;" align='center'>
                    <tr>
                        <td coslpan='3'><u><h5>&nbsp;FACTURE <?php if ($blcrdt == 1 && $blgrt == 0)
                    echo "CREDIT";
                else
                    echo "COMPTANT";
                ?> No <?php echo $num; ?>/<?php
        ...
        <table style="width:100%;">
            <tr>
                <td style="width: 100%">
                    ...
                    <table style="width:98%;" align='center'>
                        <tr>
                            <td style="text-align:center;"><u><h5>&nbsp;BORDEREAU DE LIVRAISON No <?php echo $num; ?>/<?php
                                    $dt = explode('-', $date);
                                    echo $dt[0];
                                    ?>/<?php echo NOM_STRUCT_ABBR; ?></h5></u>  </td>
            </tr>
        ...
        <table style="width:100%;">
            <tr>
                <td style="width: 100%">
                    ...
                    <table style="width:98%;" align='center'>
                        <tr>
                            <td coslpan='3'><u><h5>&nbsp;FACTURE PROFORMA No <?php echo $num; ?>/<?php
                                    $dt = explode('-', $date);
                                    echo $dt[0];
                                    ?>/<?php echo NOM_STRUCT_ABBR; ?></h5></u>  </td>
            </tr>
