...
function getExtEtatCaisse($mag, $deb, $fin, $Mysqli) {
    ...
    $query = "SELECT sum(f.remise_vnt_fact) as remise
                           FROM 
                            t_facture_vente f   
                           WHERE  f.sup_fact=0 AND date(f.date_fact) $dateq $crse";
...
<page orientation="paysage" format="A4" backtop="30mm" backbottom="10mm" backleft="20mm" backright="20mm">
    ...
    <?php if ($_SESSION['userMag'] < 1 && !empty($search['mg'])) {/* fin du premier if */ ?>  
        ...
        if ($r->num_rows > 0) {
            ...
            while ($row = $r->fetch_assoc()) {
                ...
                $marges = $response['margecpt'] + $response['margecrdt'] + $response['margegrtencaiss'];
                ...
                <table style="width:100%" align="center"> 
                    <tr>
                        <th style="width:25%">Marges Ventes comptant</th>
                        <td style="width:25%">
                            <?php echo $response['margecpt']; ?> 
                        </td>
                        <th style="width:25%">Depenses</th>
                        <td style="width:25%"><?php echo "-"; //$response['depense'];  ?></td>
                    </tr>
                    <tr>
                        <th style="width:25%">Marges Garanties Encaiss</th>
                        <td style="width:25%">
                            <?php echo $response['margegrtencaiss']; ?>
                        </td>
                        <th style="width:25%">Regl fourn..rs</th>
                        <td style="width:25%"><?php echo "-"; //$response['dette'];  ?> </td>
                    </tr>
                    <tr>
                        <th style="width:25%">Marges Reglements Clients</th>
                        <td style="width:25%">
                            <?php echo $response['margecrdt']; ?>
                        </td>
                    ...
                    <tr>
                        <th style="width:25%">Total Marges</th>
                        <td style="width:25%"><?php echo $marges; ?></td>
                ...
                <table style="width:100%" align="center">
                    <tr>
                        <th style="width:100%;background: #E7E7E7; text-align: center; font-size: 10pt;" align="center">Marge Brute : <?php echo $marges; //- $sorties;  ?> </th>
                    </tr>
                </table>
                <br/>
                <br/>
        ...
        <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 20pt;">
            <tr>
                <th style="width: 15%; text-align: Left;background-color:#E7E7E7;">MARGES</th>
                <th style="width: 35%; text-align: right;background-color:#bbb;"><?php echo number_format($margestotal, 0, ',', ' '); ?></th>
        ...
        <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 20pt;">
            <tr>
                <th style="width: 40%; text-align: Left;background-color:#E7E7E7;">MARGE NET : </th>
                <th style="width: 60%; text-align: right;background-color:#bbb;"><?php echo number_format($margestotal /* - $sortiestotal */, 0, ',', ' '); ?> FCFA</th>
            </tr>
        </table>
    ...
    <?php } else { ?>  
        ...
        while ($rowmag = $rmag->fetch_assoc()) {
            ...
            if ($r->num_rows > 0) {
                ...
                while ($row = $r->fetch_assoc()) {
                    ...
                    <table style="width:100%" align="center">
                        <tr>
                            <th style="width:100%;background: #E7E7E7; text-align: center; font-size: 10pt;" align="center">Marge Brute : <?php echo $marges;//$entrees - $sorties; ?> </th>
                        </tr>
                    </table>
                    <br/>
                    <br/>
            ...
            <table align="right" cellspacing="0" style="width: 50%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 20pt;" >
                <tr>
                    <th style="width: 35%;border:none;border-bottom:1px solid black; text-align: Left;background-color:#E7E7E7;">MARGES</th>
                    <th style="width: 65%;border:none;border-bottom:1px solid black; text-align: right;background-color:#bbb;"><?php echo number_format($margestotal, 0, ',', ' '); ?></th>
                </tr>
            ...
            <table align="right" cellspacing="0" style="width: 50%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 20pt;">
                <tr>
                    <th style="width: 40%; text-align: Left;background-color:#E7E7E7;">MARGE NET : </th>
                    <th style="width: 60%; text-align: right;background-color:#bbb;"><?php echo number_format($margestotal/*$entreestotal - $sortiestotal*/, 0, ',', ' '); ?> FCFA</th>
                </tr>
            </table>
            <br/>
            <br/>
        ...
        <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 20pt;">
            <tr>
                <th style="width: 15%; text-align: Left;background-color:#E7E7E7;">MARGES</th>
                <th style="width: 35%; text-align: right;background-color:#bbb;"><?php echo number_format($grandTotalMarges, 0, ',', ' '); ?></th>
                <th style="width: 15%; text-align: right;background-color:#E7E7E7;"> SORTIES</th>
        ...
        <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 20pt;">
            <tr>
                <th style="width: 40%; text-align: Left;background-color:#E7E7E7;">TOTAL MARGE NET : </th>
                <th style="width: 60%; text-align: right;background-color:#bbb;"><?php echo number_format($grandTotalMarges /*- $grandTotalSorties*/, 0, ',', ' '); ?> FCFA</th>
            </tr>
        </table>
        <?php
    }/* fin du else */
