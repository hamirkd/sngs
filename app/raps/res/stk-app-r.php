    ...
    if ($_SESSION['userMag'] > 0)/**/ {
        ...
        if ($r->num_rows > 0) {
            ...
            <table class="data" cellspacing="0" cellpadding="5mm" style="width: 100%; border: solid 1px black;text-align: center; font-size: 14pt;">
                ...
                while ($row = $r->fetch_assoc()) {
                    ...
                    <tr >
                        ...
                        <td style="width: 32%; text-align: left"><?php echo ucfirst(strtolower($row['nom_art'])); ?></td>
                        <td style="width: 5%;text-align: right"><?php echo $row['qte_appro_art']; ?></td> 
                        <td style="width: 8%;text-align: right"><?php echo $row['prix_appro_art']; ?></td> 
                        <td style="width: 12%;text-align: right"><?php echo $row['qte_appro_art'] * $row['prix_appro_art']; ?></td> 
                    </tr>
            ...
            <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 10pt;">
                <tr>
                    <th style="width: 75%; text-align: right;">Qte Apptovisonnee </th>
        ...
        ?>
        <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 30pt;">
            <tr>
                 <th style="width: 60%; text-align: right;">VALEUR ACHAT </th>
                <th style="width: 40%; text-align: right;"><?php echo number_format($totalmontGenerale, 0, ',', ' '); ?> </th>
            </tr>
        </table>
        <?php
    } /* fin du else */
