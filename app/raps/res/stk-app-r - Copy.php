...
<page orientation="paysage" format="A4" backtop="30mm" backbottom="10mm" backleft="10mm" backright="10mm">
    ...
    if ($_SESSION['userMag'] > 0)/**/ {
        ...
        <?php
        $query = "SELECT app.bon_liv_appro,date_format(app.date_appro,'%d %b %Y') as date_appro,app.mnt_revient_appro,
        ...
        if ($r->num_rows > 0) {
            ...
            <table class="data" cellspacing="0" cellpadding="5mm" style="width: 100%; border: solid 1px black;text-align: center; font-size: 14pt;">
                <tr style="">
                    ...
                    <th style="width: 12%;border:1px solid black;text-align: left">Tot</th> 
                </tr>
                ...
                while ($row = $r->fetch_assoc()) {
                    ...
                    $totalmtnrevient +=$row['mnt_revient_appro'];
                    ?>
                    <tr >
                        ...
                        <td style="width: 5%;text-align: right"><?php echo $row['qte_appro_art']; ?></td> 
                        <td style="width: 12%;text-align: right"><?php echo $row['mnt_revient_appro']; ?></td> 
                    </tr>
            ...
            <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 10pt;">
                <tr>
                    <th style="width: 52%; text-align: right;">Qte Apptovisonnee # Total </th>
                    <th style="width: 48%; text-align: right;"><?php echo number_format($totalqte, 0, ',', ' '); ?> # <?php echo number_format($totalmtnrevient / $total, 2, ',', ' '); ?> </th>
                </tr>
            </table>
            <?php
        }
        ...
        if ($r->num_rows > 0) {
            ...
            <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 10pt;">
                <tr>
                    <th style="width: 52%; text-align: right;">Qte Apptovisonnee # Total </th>
                    <th style="width: 48%; text-align: right;"><?php echo number_format($totalqte, 0, ',', ' '); ?> # <?php echo number_format($totalmtnrevient / $total, 0, ',', ' '); ?> </th>
                </tr>
            </table>
            <?php
        }
