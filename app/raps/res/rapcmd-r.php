...
<page backtop="30mm" format="A4" backbottom="10mm" backleft="10mm" backright="10mm">
    ...
    if ($_SESSION['userMag'] > 0)/**/ {
        ...
        $query = "SELECT  
            ...
            WHERE fv.sup_fact=0 AND fv.bl_fact_crdt=1 AND bl_fact_grt=1 AND fv.bl_crdt_regle=1 AND fv.crdt_fact>0 $condmag ";
        ...
        $query.=" ORDER BY fv.date_encaiss_grt,cl.nom_clt ASC";
        ...
        if ($r->num_rows > 0) {
            ...
            <div style="font-size: 16pt;text-transform: capitalize; 
                 font-weight: bold;" align="left">
                <u>GARANTIES PAYEES OU ENCAISSEES</u>   
            </div> 
            <br>
            <table class="data" cellspacing="0" cellpadding="5mm" style="width: 100%; border: solid 1px black;text-align: center; font-size: 10pt;">
                <tr style="">
                    ...
                    <th style="width: 20%;text-align: left;border:1px solid black;">FACTURE</th>
                ...
                while ($row = $r->fetch_assoc()) {
                    ...
                    <tr >
                        ...
                        <td style="width: 20%;border:1px solid black;text-align: left"><?php echo ucwords(strtolower($row['code_fact'])); ?>  <?php /*if ($row['bl_fact_grt'] == 1) echo "(G)";*/ ?></td>
            ...
            <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 10pt;">
                <tr>
                    <th style="width: 60%; text-align: right;">Total Commandes : </th>
        ...
        while ($rowmag = $rmag->fetch_assoc()) {
            ...
            $query.=" ORDER BY fv.date_fact,cl.nom_clt ASC";
