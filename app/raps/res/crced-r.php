...
<page backtop="30mm" format="A4" backbottom="10mm" backleft="10mm" backright="10mm">
    ...
    <div style="font-size: 20px;text-transform: capitalize; 
        ...
        <u>Liste des credits clients </u>   
        &nbsp;&nbsp;&nbsp;<u>Date du : </u>  <?php echo date('d/m/Y'); ?> 
    </div> 
    <br>
    <?php
    $grandTotal = 0;
    ...
    if ($_SESSION['userMag'] > 0)/**/ {
        ...
        if ($r->num_rows > 0) {
            ...
            <table class="data" cellspacing="0" cellpadding="5mm" style="width: 100%; border: solid 1px black;text-align: center; font-size: 10pt;">
                <tr style="">
                    ...
                    <th style="width: 15%;text-align: left;border:1px solid black;">FACTURE</th>
                    <th style="width: 40%;text-align: left;border:1px solid black;">CLIENT</th> 
                    <th style="width: 12%;text-align: left;border:1px solid black;">CONTACT</th>
                    <th style="width: 18%;text-align: left;border:1px solid black;">MONTANT</th>  
                </tr>
                ...
                while ($row = $r->fetch_assoc()) {
                    ...
                    <tr >
                        ...
                        <td style="width: 15%;border:1px solid black; text-align: left">&nbsp;<?php echo strtolower($row['code_fact']); ?></td>
                        <td style="width: 40%;border:1px solid black; text-align: left">&nbsp;<?php echo strtolower($row['code_clt'] . "-" . $row['nom_clt']); ?></td>
                        <td style="width: 12%;border:1px solid black;text-align: left"><?php echo ucwords(strtolower($row['tel_clt'])); ?>  <?php if ($row['bl_fact_grt'] == 1) echo "(G)"; ?></td>
                        <td style="width: 18%;border:1px solid black; text-align: right;"><?php echo number_format($row['mnt_crce'], 2, ',', ' '); ?></td>
                    </tr>
            ...
            <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 10pt;">
                <tr>
                    <th style="width: 60%; text-align: right;">Total credits : </th>
        ...
        $condmag = " AND fv.mag_fact=" . intval($search['mg']) . "";
            ...
            <table class="data" cellspacing="0" cellpadding="5mm" style="width: 100%; border: solid 1px black;text-align: center; font-size: 10pt;">
                ...
                while ($row = $r->fetch_assoc()) {
                    ...
                    <tr >
                        <td style="width: 15%;border:1px solid black; text-align: left"><?php echo ucfirst(strtolower($row['date_fact'])); ?><br/><?php echo $row['heure_fact']; ?></td>
                        <td style="width: 15%;border:1px solid black; text-align: left">&nbsp;<?php echo strtolower($row['code_fact']); ?></td>
                        <td style="width: 40%;border:1px solid black; text-align: left">&nbsp;<?php echo strtolower($row['nom_clt']."-".$row['nom_clt']); ?></td>
                        <td style="width: 12%;border:1px solid black;text-align: left"><?php echo ucwords(strtolower($row['tel_clt'])); ?>  <?php if ($row['bl_fact_grt'] == 1) echo "(G)"; ?></td>
                        <td style="width: 18%;border:1px solid black; text-align: right;"><?php echo number_format($row['mnt_crce'], 2, ',', ' '); ?></td>
                    </tr>
        ...
        while ($rowmag = $rmag->fetch_assoc()) {
            ...
            $condmag = " AND fv.mag_fact =" . intval($rowmag['id_mag']) . "";
