        ...
        <tr>
            <td style="width: 100%">
                ...
                <table style="width:98%;" align='center'>
                    <tr>
                        <td coslpan='3'><u><h3>&nbsp;FACTURE No <?php
                            if ($blcrdt == 1 && $blgrt == 0)
                                echo "C-";
                            ...
                            ?><?php echo $num; ?>/<?php
                                $dt = explode('-', $date);
                                echo $dt[0];
                                ?>/<?php echo NOM_STRUCT_ABBR; ?></h3></u>  </td>
        </tr>
    </table>
    <br/> 
<?php //if ($bltva==1 ):      ?>
...
<td   style="width:40%;text-align:left;border:1px solid black;font-size:8px;font-weight:bold;">
    <table>
        <tr>
            <td>REG IMP</td>
...
<?php if ($blbic == 1): ?>
        ...
        <tr>
            ...
            <th class="chiffre" style="width: 17%; text-align: right;font-style:italic;"><?php echo number_format($som * 0.0236, 2, ',', ' '); ?></th>
        </tr>
    <?php endif; ?>
        ...
        <table style="width:100%;">
            <tr>
                <td style="width: 100%">
                    ...
                    <table style="width:98%;" align='center'>
                        <tr>
                            <td style="text-align:center;"><u><h3>&nbsp;BORDEREAU DE LIVRAISON No BL<?php echo $num; ?>/<?php
                                $dt = explode('-', $date);
                                echo $dt[0];
                                ?>/<?php echo NOM_STRUCT_ABBR; ?></h3></u>  </td>
            </tr>
        ...
        <table style="width:100%;">
            <tr>
                <td style="width: 100%">
                    ...
                    <table style="width:98%;" align='center'>
                        <tr>
                            <td coslpan='3'><u><h3>&nbsp;FACTURE PROFORMA No PF<?php echo $num; ?>/<?php
                                $dt = explode('-', $date);
                                echo $dt[0];
                                ?>/<?php echo NOM_STRUCT_ABBR; ?></h3></u>  </td>
            </tr>
